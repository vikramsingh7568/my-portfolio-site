    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right" className="mobileHead">
          Hello, I am <span className="about__name">Vikram Singh</span>
        </h1>
        <Type />
        <p className="about__desc" data-aos="fade-right">
          ...
          learn new one. 15+ projects till now.
        </p>
        ...
        <button
          ...
          onClick={() => {
            window.open(
              "https://drive.google.com/file/d/1GfN2di3V-xlQh3uzf7tclvWRpYzVXSo8/view?usp=sharing"
            );
          }}
        >
          Resume
